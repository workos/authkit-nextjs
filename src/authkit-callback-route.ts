  ...
  return async function GET(request: NextRequest) {
    ...
    if (code) {
      try {
        ...
        const { accessToken, refreshToken, user, impersonator, oauthTokens, authenticationMethod } =
        ...
        if (onSuccess) {
          await onSuccess({ accessToken, refreshToken, user, impersonator, oauthTokens, authenticationMethod });
        }
